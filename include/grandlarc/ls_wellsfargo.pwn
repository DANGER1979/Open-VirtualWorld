...
// -----------------------------------------------------------------------------
// Пример Filterscript для объекта LS Wells Fargo Building
// -----------------------------------------------------------
// By Matite in March 2015
//
//
// Этот скрипт создает отредактированный объект LS Wells Fargo Building и
// удаляет существующий объект GTASA building.
//
// Предупреждение...
// Этот скрипт использует в общей сложности:
// * 1 Объект = 1 для сменного объекта строительства
// * Позволяет команде /lswf телепортировать игрока в здание LS Wells Fargo
// -----------------------------------------------------------------------------
