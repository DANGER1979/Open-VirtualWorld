...
// -----------------------------------------------------------------------------
// Пример Filterscript для нового здания СФ 1
// ----------------------------------------------
// By Matite in February 2015
//
//
// Этот скрипт создает новый объект SF Building 1 и удаляет существующий
// Объект строительства GTASA.
//
// Предупреждение...
// Этот скрипт использует в общей сложности:
// * 3 объекта = 1 для замещающего земельного объекта, 1 для внешнего объекта
// и 1 для внутреннего объекта
// * С помощью команды /СФБ телепортировать игрока к зданию СФ 1
// -----------------------------------------------------------------------------
...
public OnFilterScriptExit()
{
    ...
    SFBuilding1Object1 = CreateObject(9510, -2719.02, 861.211, 72.1562, 0, 0, 0);
    SFBuilding1Object2 = CreateObject(9671, -2719.02, 861.211, 72.1562, 0, 0, 0);
    SFBuilding1Object3 = CreateObject(715, -2693.24, 852.60, 71.74, 0, 0, 0);
